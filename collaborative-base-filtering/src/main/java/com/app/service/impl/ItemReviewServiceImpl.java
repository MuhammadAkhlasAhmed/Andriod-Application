...
public class ItemReviewServiceImpl implements ItemReviewService {
    ...
    public List<String> performCollaborativeFiltering(List<String> listOfGenres) {
    	...
    	List<String> listOfGenresReplaceSportToAction = GenreUtils.replaceGenreSportToAction(listOfGenresReplaceTalkShowToSciFi);
    	List<ItemReview> listOfItemReview = itemReviewDao.getRowAgainstGenres(listOfGenresReplaceSportToAction);
